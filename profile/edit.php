...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT username, password, whatsapp_number FROM client WHERE id = ?");
            ...
            <div class="card">
                <div class="card-body">
                    <div class="p-1">
                        ...
                        <form method="post" action="./submit.php?mac=<?php echo "$mac" ?>">
                        <form id="messageForm">
						<div class="form-group basic">
							<div class="input-wrapper">
								<label class="label" for="username">Username</label>
								<input type="disabled" id="username" name="username" class="form-control" value="<?php echo "$username" ?>" required>
							</div>
						</div>
						...
						<div class="form-group basic">
							<div class="input-wrapper">
								...
								<input type="tel" id="whatsapp" name="whatsapp" class="form-control" value="<?php echo "$whatsapp"; ?>" required>
							</div>
						</div>
						<div class="mt-2">
